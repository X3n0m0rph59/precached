...
cp -a %{_builddir}/%{name}-%{version}/support/shell/completions/precached-debugtool.bash-completion %{buildroot}/%{_datarootdir}/bash-completion/completions/precached-debugtool
